...
export default function Brands() {
  ...
  return (
    <PageLayout className="pt-0"> {/* Add pt-0 to remove top padding */}
      {/* Hero Section - Update the padding */}
      <div className="bg-gradient-to-r from-blue-50 to-pink-50 py-12 sm:py-16">
        <div className="container mx-auto px-4">
          {/* Breadcrumb */}
          ...
          <div className="text-center mb-16">
            <h1 className="text-3xl md:text-4xl font-light mb-4">Discover Our Premium K-Beauty Brands</h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                <div className="relative h-64 md:h-auto">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent md:bg-none flex items-end md:items-center">
                    <div className="p-6 text-white md:hidden">
                      <h2 className="text-2xl font-medium mb-2">{featuredBrand.name}</h2>
                ...
                <div className="p-8 flex flex-col justify-center">
                  <div className="hidden md:block">
                    <h2 className="text-2xl font-medium mb-4">{featuredBrand.name}</h2>
          ...
          {/* All Brands Grid */}
          <div>
            <h2 className="text-2xl font-light mb-8 text-center">All Brands</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {brands.map((brand, index) => (
                ...
                >
                  <div className="relative w-16 h-16 mx-auto mb-4 overflow-hidden rounded-full bg-gray-50 flex items-center justify-center">
                    <span className="text-2xl font-medium text-gray-400">{brand.name.charAt(0)}</span>
                  </div>
                  <h3 className="text-xl font-medium text-center mb-2 group-hover:text-blue-600 transition-colors">{brand.name}</h3>
          ...
          <div className="mt-20 text-center">
            <h2 className="text-2xl font-light mb-4">Our Brand Philosophy</h2>
