          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {brands.map((brand, index) => (
                ...
                >
                  <div className="relative w-16 h-16 mx-auto mb-4 overflow-hidden rounded-full bg-gray-100 flex items-center justify-center">
                    <span className="text-2xl font-medium text-black">{brand.name.charAt(0)}</span>
                  </div>
