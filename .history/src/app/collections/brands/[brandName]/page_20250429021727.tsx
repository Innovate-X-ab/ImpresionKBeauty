...
// Since we're using 'use client', we can use client-side hooks
// instead of relying on the params prop
export default function BrandPage() {
  ...
  // Extract brandName from pathname
  const brandSlug = pathname.split('/').pop()?.toLowerCase() || '';
