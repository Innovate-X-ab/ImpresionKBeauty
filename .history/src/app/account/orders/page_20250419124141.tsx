...
import { getImageUrl } from '@/lib/utils'; // Add this import
...
export default function OrdersPage() {
  ...
  const getValidImageUrl = (imagePath: string) => {
    if (!imagePath) return '/images/placeholder.jpg'; // Provide a fallback image
    ...
    <div className="p-6">
      ...
      {orders.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2 text-gray-900">No orders yet</h3>
