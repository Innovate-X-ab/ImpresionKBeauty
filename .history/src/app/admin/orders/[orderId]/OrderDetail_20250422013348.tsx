...
export default function OrderDetailClient({ orderId }: OrderDetailClientProps) {
  ...
  useEffect(() => {
    async function fetchOrder() {
      try {
        ...
        // Create payment info
        const paymentInfo = {
          paymentId: orderData.stripeSessionId || orderData.paymentInfo?.paymentId || 'N/A',
          paymentMethod: 'Credit Card',
          paymentStatus: 'Paid',
          paymentDate: orderData.createdAt // Keep the same format as createdAt
        };
        ...
        // Don't try to convert the date to a Date object - leave it as a string
        const formattedOrder: AdminOrder = {
          id: orderData.id,
          createdAt: orderData.createdAt, // Keep as is - don't convert
  ...
  const handleUpdateStatus = async (newStatus: OrderStatus) => {
    try {
      ...
      // Create payment info
      const paymentInfo = {
        paymentId: updatedOrderData.stripeSessionId || updatedOrderData.paymentInfo?.paymentId || 'N/A',
        paymentMethod: 'Credit Card',
        paymentStatus: 'Paid',
        paymentDate: updatedOrderData.createdAt // Keep as is
      };
      ...
      // Create order object without date conversion
      const formattedOrder: AdminOrder = {
        id: updatedOrderData.id,
        createdAt: updatedOrderData.createdAt, // Keep as is - don't convert
