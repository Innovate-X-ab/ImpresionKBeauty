  ...
  useEffect(() => {
    async function fetchOrder() {
      try {
        ...
        // Ensure createdAt is properly parsed and all required properties are present
        const formattedOrder: AdminOrder = {
          ...orderData,
          createdAt: orderData.createdAt ? new Date(orderData.createdAt) : new Date(),
          paymentId: orderData.paymentId || '', // Ensure paymentId is included
          status: orderData.status as OrderStatus
        };
        
        console.log('Fetched order data:', {
          rawCreatedAt: orderData.createdAt,
          parsedCreatedAt: formattedOrder.createdAt
        });

        setOrder(formattedOrder as AdminOrder);
      } catch (err) {
