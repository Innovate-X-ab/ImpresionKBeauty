...
// Add a helper function for date formatting at the top of the file after imports
...
// Update the Order interface to only use number types
interface Order {
  id: string;
  createdAt: string | Date;
  status: string;
  totalAmount: number; // Only number, not Decimal
  user: {
    name: string | null;
    email: string;
    id: string;
  ...
  orderItems: Array<{
    id: string;
    quantity: number;
    price: number; // Only number, not Decimal
    product: {
      id: string;
      name: string;
      price?: number; // Optional price field as number
    } | null;
  }>;
}
