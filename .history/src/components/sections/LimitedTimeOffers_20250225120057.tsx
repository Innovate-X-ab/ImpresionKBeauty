    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl font-light mb-4 relative inline-block">
            Special Offers
          ...
          <div className={`rounded-xl overflow-hidden shadow-md ${offers[currentIndex].backgroundColor}`}>
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-8 flex flex-col justify-between">
                <div>
                  <h3 className="text-2xl font-light mb-3">{offers[currentIndex].title}</h3>
                  <p className="text-gray-600 mb-6">{offers[currentIndex].description}</p>
                  
                  <div className="flex items-center space-x-3 mb-6">
                    <span className="text-2xl font-medium">${offers[currentIndex].salePrice.toFixed(2)}</span>
