      ...
      <div className="container mx-auto px-3 sm:px-4 py-1 sm:py-2"> {/* Reduced padding */}
        ...
        <div className="flex items-center justify-between pt-2"> {/* Added top padding */}
          ...
          <Link href="/" className="flex items-center space-x-2">
            <div className="relative w-[200px] sm:w-[250px] md:w-[300px] h-[60px] sm:h-[70px] md:h-[80px]">
              <Image
                src="/images/logo.jpg"
            ...
            <span className="hidden md:block text-xl sm:text-2xl font-light tracking-wide text-gray-900 whitespace-nowrap">
              IMPRESSION K BEAUTY
            </span>
          </Link>
