    ...
    <div className="absolute inset-0 origin-left scale-[2.2] sm:scale-[3.2] md:scale-[4.5]">
      ...
      />
          ...
          <div className="flex-1 mx-6 max-w-md hidden md:block">
            <form onSubmit={handleSearch} className="relative group">
              <input
                ...
                className="w-full py-2 px-10 border border-gray-300 bg-white rounded-full focus:outline-none focus:ring-1 focus:ring-black transition-all duration-200 text-sm"
              />
          ...
          <button
            ...
            className="md:hidden p-2 hover:bg-gray-100 rounded-full text-gray-800"
          ...
          <div className="md:hidden mt-4 mb-2">
            <form onSubmit={handleSearch} className="relative">
              <input
                ...
                onChange={(e) => setSearchQuery(e.target.value)}
                placeholder="Search products..."
                className="w-full py-2 px-10 border border-gray-300 bg-white rounded-full focus:outline-none focus:ring-1 focus:ring-black text-sm"
                autoFocus
              />
              <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-600 w-4 h-4" />
              {searchQuery && (
        ...
        <div className="lg:hidden fixed inset-0 bg-white z-50 pt-16 sm:pt-20 overflow-y-auto">
          <div className="container mx-auto px-4 py-4">
            ...
            {session ? (
              <Link
                href="/account"
                className="text-base sm:text-lg font-medium py-2 border-b border-gray-100 flex items-center text-gray-800"
            ...
            {/* Main Navigation - Simplified to match desktop */}
