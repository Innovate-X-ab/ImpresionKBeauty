          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-2">
                ...
                <img src='/images/products/mastercard.jpg' alt="Mastercard" className="h-8" />
                <img src='/images/products/apple-pay.png' alt="Apple Pay" className="h-8" />
                <img src='/images/products/pay-pal.png' alt="PayPal" className="h-8" />
              </div>
            </div>
          </div>
        </div>
