      ...
      <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center">
            <div className="relative w-[150px] sm:w-[180px] md:w-[200px] h-[40px] sm:h-[45px] md:h-[50px]">
              <Image
                src="/images/logo.jpg"
            ...
            {/* Optional: Remove or keep text logo as fallback */}
            <span className="sr-only">IMPRESSION K BEAUTY</span>
          </Link>
