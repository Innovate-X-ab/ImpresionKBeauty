    ...
    <footer className="bg-white border-t border-gray-100">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h4 className="text-lg text-black font-medium mb-6">IMPRESSION K BEAUTY</h4>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg text-black font-medium mb-6">Quick Links</h4>
          ...
          <div>
            ...
            <div className="space-y-4">
              <h5 className="font-medium">Payment Methods</h5>
