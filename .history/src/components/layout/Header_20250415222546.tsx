      ...
      <div className="container mx-auto px-3 sm:px-4">
        ...
        <div className="flex items-center justify-between py-2">
          ...
          <Link href="/" className="flex items-center space-x-2">
            {/* Instead of fill + fixed width/height, use a normal Image size to ensure it displays properly */}
            ...
            {/* Always show the brand text, and set it to a dark color to match the logo */}
            <span className="text-base sm:text-xl font-light tracking-wider text-black whitespace-nowrap">
              IMPRESSION K BEAUTY
            </span>
          </Link>
