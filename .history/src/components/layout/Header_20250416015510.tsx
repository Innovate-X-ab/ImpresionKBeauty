...
// Import a creative font from Google Fonts using Next.js built-in loader
import { Playfair_Display } from 'next/font/google';

// Initialize the font with the desired configuration
          ...
          <Link href="/" className="flex items-center space-x-2">
            <div className="relative w-[50px] h-[50px]">
              <Image
                ...
                fill
                className="object-contain scale-[5.35]" 
                priority
              />
            </div>
            {/* <span
              // Apply the custom font and creative gradient style
              className={`${playfair.className} bg-gradient-to-r from-pink-500 to-red-500 bg-clip-text text-transparent text-base sm:text-xl tracking-wider whitespace-nowrap`}
            >
              IMPRESSION K BEAUTY
            </span> */}
          </Link>
