      ...
      <div className="container mx-auto px-4 py-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-6">
            ...
            {/* Cart Icon */}
            <Link href="/cart" className="relative p-1 hover:bg-black-100 rounded-full group">
        ...
        {/* Decorative Border */}
        <div className="relative h-1 mt-4 bg-gradient-to-r from-blue-50 via-blue-100 to-blue-50 rounded-full"></div>
