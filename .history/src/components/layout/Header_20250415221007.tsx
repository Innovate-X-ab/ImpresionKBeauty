  ...
  return (
    <header ref={dropdownRef} className="w-full bg-white z-50 relative shadow-sm">
      <div className="container mx-auto px-3 sm:px-4">
        {/* Free shipping banner - Absolute positioned */}
        <div className="hidden sm:flex justify-center items-center text-xs py-1 px-4 bg-gray-50 rounded-full absolute top-0 left-1/2 transform -translate-x-1/2">
          <span className="font-medium text-black">Free shipping on orders over £50</span>
        </div>
        
        <div className="flex items-center justify-between">
          {/* Logo and Brand Name - Adjusted size */}
          <Link href="/" className="flex items-center">
            <div className="flex items-center">
              <div className="relative w-[180px] sm:w-[200px] md:w-[220px] h-[50px] sm:h-[55px] md:h-[60px]">
                <Image
                  src="/images/logo.jpg"
              ...
              {/* Brand name - Positioned next to logo */}
              <span className="hidden md:block text-xl font-light tracking-wider text-gray-900 whitespace-nowrap ml-2">
                IMPRESSION K BEAUTY
              </span>
            </div>
          </Link>
          ...
          <div className="flex items-center space-x-3 sm:space-x-6">
            ...
            <div className="hidden lg:flex items-center space-x-4 sm:space-x-6">
              ...
              {/* Changed to a normal link instead of a dropdown button */}
              <Link 
        ...
        <div className="lg:hidden fixed inset-0 bg-white z-50 pt-16 sm:pt-20 overflow-y-auto">
          <div className="container mx-auto px-4 py-4">
            ...
            <nav className="flex flex-col">
              ...
              {/* Updated mobile menu for Brands - now links to brands page */}
              <Link 
                href="/collections/brands" 
                className="text-base sm:text-lg font-medium py-2 border-b border-gray-100"
                onClick={() => setIsMenuOpen(false)}
