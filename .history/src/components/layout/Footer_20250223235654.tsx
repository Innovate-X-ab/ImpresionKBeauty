          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-2">
                <img src='/images/products/serums.jpg' alt="Visa" className="h-8" />
                <img src='/images/products/serums.jpg' alt="Mastercard" className="h-8" />
                <img src='/images/products/serums.jpg' alt="Apple Pay" className="h-8" />
                <img src='/images/products/serums.jpg' alt="PayPal" className="h-8" />
              </div>
            </div>
          </div>
        </div>
