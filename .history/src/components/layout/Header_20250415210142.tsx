...
export default function Header() {
  ...
  return (
    <header ref={dropdownRef} className="w-full bg-white z-50 relative shadow-sm">
      <div className="container mx-auto px-3 sm:px-4 py-1 sm:py-2"> {/* Reduced padding */}
        ...
        <div className="flex items-center justify-between pt-2"> {/* Added top padding */}
          {/* Logo and Brand Name */}
          <Link href="/" className="flex items-start justify-start">
            <div className="flex items-center">
              <div className="relative w-[250px] sm:w-[300px] md:w-[350px] h-[70px] sm:h-[80px] md:h-[90px]">
                <Image
                  src="/images/logo.jpg"
              ...
              {/* Brand name with adjusted positioning */}
              <span className="hidden md:block text-2xl sm:text-3xl font-light tracking-wider text-gray-900 whitespace-nowrap pl-2 -ml-4">
                IMPRESSION K BEAUTY
              </span>
            </div>
          </Link>
