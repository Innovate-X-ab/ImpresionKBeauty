        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3 sm:space-x-6">
            ...
            {session ? (
              <Link 
                href="/account" 
                className="hidden sm:flex items-center text-xs sm:text-sm font-medium text-gray-800 hover:text-black px-2 py-1 hover:bg-gray-50 rounded-md transition-colors"
              >
