...
const ProductGrid = ({ products = [] }: ProductGridProps) => {  // Add default empty array
  ...
  const handleAddToCart = async (product: Product, e: React.MouseEvent) => {
    ...
    try {
      ...
      addItem(cartProduct, getQuantity(product.id));
            ...
            <div className="mt-2 w-full flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className="p-1.5 rounded-md bg-gray-200 hover:bg-gray-300"
                >
              ...
              <button
                ...
                className="bg-black text-white py-1.5 px-3 rounded-md hover:bg-gray-800 flex items-center justify-center transition-colors text-sm"
