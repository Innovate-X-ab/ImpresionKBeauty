...
export default function ProductForm({ onSuccess, initialData = null }: { onSuccess: () => void, initialData: ProductData | null }) {
...
interface ApiResponse {
    ...
    const handleSubmit = async (e: FormSubmitEvent): Promise<void> => {
        ...
        try {
            const response: ApiResponse = await fetch('/api/admin/products', {
                method: 'POST',
                headers: {
